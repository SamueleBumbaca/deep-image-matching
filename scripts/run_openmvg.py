...
CAMERA_SENSOR_WIDTH_DIRECTORY = (
    "/home/threedom/Desktop/github_lcmrl/openMVG/src/software/SfM"
    + "/../../openMVG/exif/sensor_width_database"
)  # Indicate the openMVG camera sensor width directory
os.chdir(os.path.dirname(os.path.abspath(__file__)))
input_eval_dir = os.path.abspath(
    "/home/threedom/Desktop/github_3dom/deep-image-matching/assets/pytest/results_superpoint+lightglue_bruteforce_quality_high/openmvg/"
)
