...
from src.deep_image_matching.thirdparty.hloc import (
    extract_features,
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--imgs_dir", type=str, help="Path to the directory containing the images"
    )
    ...
    parser.add_argument(
        ...
        type=str,
        default="netvlad",
        help="Configuration for retrieval, e.g. netvlad",
    )
    parser.add_argument(
        "--kmeans_clusters",
        type=int,
